...
**Read the [troubleshooting guide](https://github.com/panekj/vscode-powershell/blob/release/v2021.10.0/./docs/troubleshooting.md) for answers to common questions.**
...
[the troubleshooting docs](https://github.com/panekj/vscode-powershell/blob/release/v2021.10.0/./docs/troubleshooting.md) for information
on diagnosing and reporting issues.

## Security Note

For any security issues, please see [here](https://github.com/panekj/vscode-powershell/blob/release/v2021.10.0/./docs/troubleshooting.md#note-on-security).
...
check out the included [README.md](https://github.com/panekj/vscode-powershell/blob/release/v2021.10.0/examples/README.md) file to learn more about
how to use them.
...
Check out the [development documentation](https://github.com/panekj/vscode-powershell/blob/release/v2021.10.0/docs/development.md) for more details
...
This extension is [licensed under the MIT License](https://github.com/panekj/vscode-powershell/blob/release/v2021.10.0/LICENSE.txt).  Please see the
[third-party notices](https://github.com/panekj/vscode-powershell/blob/release/v2021.10.0/Third%20Party%20Notices.txt) file for details on the third-party
